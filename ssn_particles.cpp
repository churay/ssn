...
static_assert( LLCE_ELEM_COUNT(PARTICLE_UPDATE_FUNS) == ssn::particle_t::type_e::_length,
...
static_assert( LLCE_ELEM_COUNT(PARTICLE_RENDER_FUNS) == ssn::particle_t::type_e::_length,
